...
function Home(){
    ...
    return(
        ...
        <div className="h-screen w-full bg-white grid place-content-center gap-2">
            ...
            {/* adding user image */}
        <div className="h-[350px] w-full border-[0px] border-red-300 rounded-lg shadow-lg flex justify-center items-center">
            ...
            {/* adding user name */}
        <div className="flex justify-center items-center"><p className="text-2xl font-bold text-red-300 uppercase">jay <span className="text-2xl font-bold bg-gradient-to-r from-red-300 to-cyan-300 bg-clip-text text-transparent uppercase">maa durga</span></p></div>
            {/* adding user details */}
        <div className="flex justify-center items-center"><p>Happy Navratri To You And Your Family</p></div>
            {/* adding user details */}
        <div className="flex justify-center items-center"><p>From Raushan Raj</p></div>
